...
type IKeyStore = 'token' | 'merchantCode' | 'merchantId' | 'mid' | 'tid' | 'pathname' | 'merchantName' | 'isConfirmDevice' | 'iClient';
...
const storage = {
  ...
  isConfirmDevice: genGetSetKeyLocal('isConfirmDevice'),
  iClient: genGetSetKeyLocal('iClient'),
};
